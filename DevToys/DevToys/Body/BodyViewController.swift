...
final class BodyViewController: NSViewController {
    ...
    private lazy var hyphenationFormatterController = HyphenationRemoverViewController()
    ...
    override func viewDidAppear() {
        appModel.$toolType
            .sink{[unowned self] toolType in
                ...
                case .hyphenationRemover: self.replaceContentViewController(hyphenationFormatterController)
